...
namespace Transportathon.Migrations.AddDbContext
{
    ...
    [Migration("20230915122400_ApplyDatabase")]
    partial class ApplyDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transportathon.Models.CreateJob", b =>
                {
                    b.HasOne("Transportathon.Models.ApplyDriver", null)
                        .WithMany("Jobs")
                        .HasForeignKey("ApplyDriverId");
                });
